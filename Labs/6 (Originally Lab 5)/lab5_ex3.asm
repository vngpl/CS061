...
do_while_compare
    ...
    brz is_a_palindrome ; if 0 middle reached, jump to palindrome condition

    ; if middle not reached, continue comparing
    ldr r3, r1, #0  ; r3 <- r1
    ldr r4, r2, #0  ; r4 <- r2
    ...
    brnp not_a_palindrome   ; if not 0, characters dont match, jump to not palindrome condition
    
    add r1, r1, #1  ; increment r1 to next char mem adr
    add r2, r2, #-1 ; decrement r2 to previous char mem adr
    br do_while_compare
    
    is_a_palindrome ; r4 = 1 if palindrome
        add r4, r4, #1
        br end_do_while_compare
    
    not_a_palindrome ; r4 = 0 if not palindrome
        and r4, r4, #0
...
ld r2, lower_to_upper_mask ; load mask xDF = 1101 1111

do_while_convert_case
    ldr r0, r1, #0
    add r0, r0, #0
    brz end_do_while_convert_case ; once null is reached, terminate
    
    and r0, r0, r2  ; and with the bit mask
    str r0, r1, #0
    
    add r1, r1, #1
    br do_while_convert_case
end_do_while_convert_case
